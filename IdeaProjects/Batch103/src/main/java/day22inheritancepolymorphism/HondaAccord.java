...
public class HondaAccord extends Honda{
    ...
    /*
        ...
        5) "this" keyword "BU Class" anlamindadir. "this.price" demek bu Class'daki "price" isimli variable demektir.
         ...
         6) Constructor kullanarak variable'lar uyerinde yaptiginiz degisimler sadece Object uyerindek variable'larin degerleri degistrir
            Class daki variable degerleri degistrimez...
