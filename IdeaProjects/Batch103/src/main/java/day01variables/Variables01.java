...
public class Variables01 {
    ...
    // " Assignment (Atama) Operator" sadaki degeri alir soldaki variableìn icine koyar public int age = 13;
    ...
    /*
     ...
     1) int:     Integer´ín kisalmasi. Integer tam sayi demektir. 32 bit kullanir yada $ byte
     ...
     5) float:   Ondaliki sayilar icindir. 32 bit kullanir.
                 "flaat" virgülden sonra 7 basamak icerebilir.
                 "flaat" degerlerinin sonu "f" veya "F" koymaniz gerekir.
     ...
     8) char:    Tek karakterler icin kullanilir. 16 bit kullanir.
      ...
      String: Isim, adres, kimlik numarasi gibi bir veya birden fazla karakter iceren degerler kullanilir.
              ...
              1) Non-Primitive data type'larinda degerlerin yaninda method´lar vardir.
                 Primitive data type´larinda ise sadece deger vardir, method yoktur.
              2) Primitive data type´lari Java tarafindan olusturulmustur, toplam 8 tanedir, biz Primitative data olusturamayiz.
                 Non- Primitive data type´leri Java tarafindan da olusturulmustur, biz de olusturabiliriz. Non-Primitive
                 sayilmyacak kadar coktur, cunku her developer Non-Primitive data type olusturabilirsiniz.
              3) Primitive data type isimleri kucuk harflerle baslar.
                 Non-Primitive data type isimleri buyuk harfle baslar.
              4) Primitiv edata typle´lar memory´de farkli büyüklüklerde yerler kullanir.
                 Non-Primitive´lerin hepsi memory´de ayni büyüklükte yer kullanir.
     */
    ...
    // Bu yüzden, long bir vaiable'a "int" araliginin disinda bir sayi verirseniz mutlaka sonuna "L" veya "l" koyunuz.
